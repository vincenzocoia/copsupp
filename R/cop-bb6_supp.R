...
#' @rdname bb6_supp
#' @export
pbb6r <- function(u, v, cpar) u + v - 1 + pbb6(1-u, 1-v, cpar)

## Density

#' @rdname bb6_supp
#' @export
dbb6r <- function(u, v, cpar) dbb6(1-u, 1-v, cpar)
#' @rdname bb6_supp
#' @export
...
#' @rdname bb6_supp
#' @export
rbb6r <- function(n, cpar) 1 - rbb6(n, cpar)

## Conditional distribution

#' @rdname bb6_supp
#' @export
pcondbb6r <- function(v, u, cpar) 1 - pcondbb6(1-v, 1-u, cpar)
#' @rdname bb6_supp
#' @export
qcondbb6r <- function(p, u, cpar) 1 - qcondbb6(1-p, 1-u, cpar)
...
#' @rdname bb6_supp
#' @export
dbb6u <- function(u, v, cpar) dbb6(1-u, v, cpar)
#' @rdname bb6_supp
#' @export
...
#' @rdname bb6_supp
#' @export
dbb6v <- function(u, v, cpar) dbb6(u, 1-v, cpar)
#' @rdname bb6_supp
#' @export
